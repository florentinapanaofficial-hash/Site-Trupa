export const siteContent = {
  brand: {
    ...
    tagline: 'Muzică live pentru evenimente care rămân în memorie.',
  },
  seo: {
    title: 'Formația Florentina Pană | Muzică live pentru nunți și evenimente',
    description:
      'Formația Florentina Pană aduce show live pentru nunți, botezuri și evenimente corporate. Repertoriu variat, artiști profesioniști și energie pe scenă.',
  ...
  hero: {
    ...
    description:
      'Combinăm hituri actuale, piese clasice și momente personalizate într-un spectacol viu, ritmat și memorabil pentru invitații dvs.',
    ctaPrimary: { label: 'Sună acum', href: 'tel:+40767369658' },
    ctaSecondary: { label: 'Ascultă live', href: '#video' },
    bullets: [
      'Setup profesional de scenă și sunet',
      'Program adaptat pe stilul evenimentului',
      'Comunicare rapidă și organizare clară',
    ],
  },
  videos: [
    {
  ...
  videoAdmin: {
    ...
    showAdminHints: true,
    categories: [
      { id: 'petrecere', title: 'Muzică Populară & de Petrecere' },
      { id: 'usoara-diverse', title: 'Muzică Ușoară / Diverse Genuri' },
      { id: 'tineret-manele', title: 'Tineret' },
    ],
  },
  realMoments: {
    stats: {
  ...
  news: {
    intro:
      'Publică noutăți despre formație, repertoriu și evenimente. Comunitatea poate trimite cereri de piese direct din site.',
    posts: [
      {
        title: 'Noutăți de sezon: repertoriu 2026',
        date: '10 martie 2026',
        category: 'Repertoriu Nou',
        summary:
          'Am adăugat piese noi de petrecere, muzică ușoară și momente dedicate pentru publicul tânăr.',
      },
      {
        title: 'Echipă extinsă pentru evenimente premium',
        date: '8 martie 2026',
        category: 'Membri Noi',
        summary:
          'Colaborăm cu instrumentiști invitați pentru show-uri tematice și seturi personalizate.',
      },
      {
        title: 'Programări deschise pentru toamnă-iarnă',
        date: '5 martie 2026',
        category: 'Evenimente',
        summary:
          'Acceptăm rezervări pentru nunți, botezuri și petreceri corporate cu pachete flexibile.',
      },
    ],
    approvedComments: [
      {
        author: 'Mirela C.',
        relatedPost: 'Noutăți de sezon: repertoriu 2026',
        text: 'Super selecție de piese noi. Energia de pe scenă a fost exact ce ne-am dorit la eveniment.',
        reaction: '❤️',
        trustLevel: 'confirmat',
      },
      {
        author: 'Alexandru T.',
        relatedPost: 'Programări deschise pentru toamnă-iarnă',
        text: 'Comunicare foarte bună și organizare impecabilă. Recomand cu mare drag.',
        reaction: '👍',
  ...
  services: [
    {
      title: 'Nunți',
      description:
        'Program complet pe momente-cheie, de la primirea invitaților până la final.',
    },
    {
      title: 'Botezuri',
      description:
        'Atmosferă caldă și repertoriu echilibrat pentru invitați de toate vârstele.',
    },
    {
      title: 'Corporate',
      description:
        'Setlist premium și prezență scenică profesionistă pentru evenimente business.',
    },
  ],
  repertoire: [
    {
  ...
  gallery: [
    { alt: 'Moment live la nuntă', image: '' },
    { alt: 'Scenă și invitați în dans', image: '' },
    { alt: 'Band setup în lumini de scenă', image: '' },
    { alt: 'Atmosfera pe ringul de dans', image: '' },
    { alt: 'Moment artistic live', image: '' },
    { alt: 'Public în energie maximă', image: '' },
  ],
  faq: [
    {
