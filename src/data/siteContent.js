export const siteContent = {
    ...
    hero: {
        ...
        description: 'Combinăm hituri actuale, piese clasice și momente personalizate într-un spectacol viu, ritmat și memorabil pentru invitații dvs.',
        ...
        events: [
            {
                ...
                youtubeUrl: '',
                coupleQuote: '"Formația Florentina Pană ne-a făcut nunta exact cum am visat: repertoriu variat, energie superbă și comunicare impecabilă cu invitații. Îi recomandăm din tot sufletul!"',
            },
        ],
    },
    news: {
        intro: 'Publică noutăți despre formație, repertoriu și evenimente. Comunitatea poate trimite cereri de piese direct din site.',
        posts: [
            {
                title: 'Noutăți de sezon: repertoriu 2026',
                date: '10 martie 2026',
                category: 'Repertoriu Nou',
                summary: 'Am adăugat piese noi de petrecere, muzică ușoară și momente dedicate pentru publicul tânăr.',
            },
            {
                title: 'Echipă extinsă pentru evenimente premium',
                date: '8 martie 2026',
                category: 'Membri Noi',
                summary: 'Colaborăm cu instrumentiști invitați pentru show-uri tematice și seturi personalizate.',
            },
            {
                title: 'Programări deschise pentru toamnă-iarnă',
                date: '5 martie 2026',
                category: 'Evenimente',
                summary: 'Acceptăm rezervări pentru nunți, botezuri și petreceri corporate cu pachete flexibile.',
            },
        ],
    },
    tvAppearances: [
        ...
        vocalists: [
            {
                ...
                description: 'Solistă principală cu timbru cald și prezență scenică elegantă. Interpretează toate tipurile de muzică: populară de petrecere, grecească, arăbească, machedonească, latino, muzică românească și manele, iar trupa cântă fără pauze.',
            ...
            },
            {
                ...
                description: 'Membru al trupei responsabil de programele speciale de muzică populară de petrecere și jocuri tradiționale. Împreună alternăm programele artistice în funcție de specificul fiecărui eveniment, exclusiv live, fără DJ sau MC.',
