...
import { b as blogPosts } from '../chunks/blogPosts_BHqddqS1.mjs';
...
<input data-upload-url class="input-glass" type="text" readonly placeholder="Va apărea aici după upload" data-astro-cid-46mpiyzq> </label> </form> </section> <div class="community-main-layout mx-auto max-w-7xl gap-5 grid grid-cols-1 md:grid-cols-[0.8fr_1.7fr]" data-astro-cid-46mpiyzq> <section class="community-feed-column min-w-0 md:max-w-md" data-astro-cid-46mpiyzq> <div class="community-toolbar sticky top-24 z-20 mb-4 grid gap-3 rounded-2xl border border-white/20 bg-[#0a1433de] p-3 backdrop-blur sm:grid-cols-[1fr_auto] sm:items-center" data-astro-cid-46mpiyzq> <div class="flex items-center gap-3" data-astro-cid-46mpiyzq> <div class="community-avatar" aria-hidden="true" data-astro-cid-46mpiyzq>FP</div> <label class="w-full" for="new-community-post" data-astro-cid-46mpiyzq> <span class="sr-only" data-astro-cid-46mpiyzq>Creare postare</span> <input id="new-community-post" type="text" class="input-glass w-full" placeholder="Ce vrei să postezi astăzi în comunitate?" readonly data-astro-cid-46mpiyzq> </label> </div> <div class="flex flex-wrap gap-2" data-astro-cid-46mpiyzq> <button type="button" class="btn-outline" data-create-post-demo data-astro-cid-46mpiyzq>Publică postare</button> <select class="input-glass min-w-48" data-feed-sort aria-label="Sortează feed-ul comunității" data-astro-cid-46mpiyzq> <option value="newest" selected data-astro-cid-46mpiyzq>Cele mai noi</option> <option value="top" data-astro-cid-46mpiyzq>Cele mai apreciate</option> </select> <div class="community-filter-wrap flex flex-wrap gap-2" role="group" aria-label="Filtrează postările comunității" data-astro-cid-46mpiyzq> <button type="button" class="community-filter-btn is-active" data-feed-filter="all" aria-pressed="true" data-astro-cid-46mpiyzq>Toate</button> <button type="button" class="community-filter-btn" data-feed-filter="gallery" aria-pressed="false" data-astro-cid-46mpiyzq>Galerie Video</button> <button type="button" class="community-filter-btn" data-feed-filter="tv" aria-pressed="false" data-astro-cid-46mpiyzq>Apariții TV</button> </div> </div> </div> <div class="community-feed grid w-full max-w-none gap-4" data-astro-cid-46mpiyzq> ${feedPosts.map((item, index) => {
...
Cere ofertă pe WhatsApp pentru acest tip de moment
  ...
  })} </div> </section> <aside id="blog" class="community-editorial-column min-w-0" aria-label="Publicații și Vlog" data-astro-cid-46mpiyzq> <div class="blog-aside-header" data-astro-cid-46mpiyzq> <p class="blog-aside-kicker" data-astro-cid-46mpiyzq>Publicații &amp; Vlog</p> <h2 class="blog-aside-title" data-astro-cid-46mpiyzq>Articole &amp; povești</h2> <p class="blog-aside-sub" data-astro-cid-46mpiyzq>Muzică, culise și ghiduri utile pentru evenimentul tău — scrise de noi, pentru tine.</p> </div> <div class="blog-list" data-astro-cid-46mpiyzq> ${blogPosts.map((post) => {
  ...
  })} </div> <a${addAttribute(`/blog/${blogPosts[0].slug}`, "href")} class="blog-aside-cta" data-astro-cid-46mpiyzq>
Citește ultimul articol
<svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" aria-hidden="true" data-astro-cid-46mpiyzq><path d="m9 18 6-6-6-6" data-astro-cid-46mpiyzq></path></svg> </a> </aside> </div> </section>   ` })}`;
