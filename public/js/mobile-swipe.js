...
(function () {
    var cleanupMobileSwipe = function () { };
    ...
    function initMobileSwipe() {
        ...
        (function initPTR() {
            ...
            function createIndicator() {
                ...
                ptrIndicator.setAttribute('data-ptr-indicator', 'true');
            ...
            document.addEventListener('touchend', ptrEnd, { passive: true, signal: controller.signal });
            document.addEventListener('touchcancel', ptrEnd, { passive: true, signal: controller.signal });
        })();
        ...
        window.addEventListener('resize', debounce(function () {
            requestAnimationFrame(cacheNavBtnPositions);
        }, 200), { passive: true, signal: controller.signal });
        ...
        document.addEventListener('astro:before-swap', cleanupMobileSwipe, { once: true });
    ...
    initMobileSwipe();
    document.addEventListener('astro:page-load', initMobileSwipe);
})();
